...
for i in range(9):
    for j in range(i + 1, 10):
        ...
        x_train = np.append(x_train, x_s[0][:112].reshape(112, 32, 32, 3), axis=0)
        x_test = np.append(x_test, x_s[0][-23:].reshape(23, 32, 32, 3), axis=0)
print("completed")
print("label...")
y_train = []
y_test = []
...
y_train = y_train + [10 for i in range(5040)]
y_test = y_test + [10 for i in range(1035)]
...
def resnet_v2(input_shape, depth, num_classes=11):
